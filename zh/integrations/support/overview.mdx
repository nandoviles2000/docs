---
title: "支持集成"
description: "将你的 Mintlify 文档连接到 Intercom 和 Front 等支持平台，让访客能够直接在文档页面中获得实时帮助。"
keywords: ["客户支持平台", "帮助台集成", "支持组件", "客户支持"]
---
...
将客户支持小组件集成到文档中。在 `docs.json` 文件中添加 `integrations` 字段，并填入相应的应用 ID 或聊天 ID。有关如何查找这些 ID，请参阅各集成的文档。