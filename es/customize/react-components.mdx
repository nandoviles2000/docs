---
title: "React"
description: "Crea elementos interactivos y reutilizables con componentes personalizados de React en tu documentación de Mintlify mediante JSX, estado y lógica del lado del cliente."
...
Para importar componentes de React en tus archivos MDX, los archivos de componentes deben estar en la carpeta `/snippets/`. Obtén más información sobre los [snippets reutilizables](/es/create/reusable-snippets).

<Note>
  No se admiten las importaciones anidadas. Si un componente de React hace referencia a otros componentes, debes importar todos los componentes directamente en el archivo MDX principal, en lugar de importarlos dentro de los archivos de componentes.
</Note>
...
<AccordionGroup>
  <Accordion title="Impacto del renderizado del lado del cliente">
    Los componentes que usan hooks de React se renderizan del lado del cliente, lo que tiene varias implicaciones:

    * **SEO**: Es posible que los motores de búsqueda no indexen por completo el contenido dinámico.
    * **Carga inicial**: Los visitantes pueden ver brevemente contenido de carga antes de que se rendericen los componentes.
  ...
  <Accordion title="Buenas prácticas de rendimiento">
    ...
    * **Carga diferida**: Considera cargar de forma diferida los componentes complejos para mejorar el tiempo de carga inicial de la página.
  </Accordion>
</AccordionGroup>