...
description: "Conecta tu documentación de Mintlify con plataformas de soporte como Intercom y Front para que los visitantes puedan recibir ayuda en tiempo real directamente desde las páginas de tu documentación."
keywords: ["plataformas de atención al cliente", "integración de centro de ayuda", "widgets de soporte", "asistencia al cliente"]
---
...
<div id="enabling-support-integrations">
  ## Habilita las integraciones de soporte
</div>

Integra widgets de soporte en tu documentación. Agrega el campo `integrations` a tu archivo `docs.json` con el ID de la aplicación o del chat correspondiente. Consulta la documentación de cada integración para obtener instrucciones sobre cómo encontrar tu ID.