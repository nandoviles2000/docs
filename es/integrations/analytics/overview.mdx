...
description: "Conecta tu documentación de Mintlify a plataformas de analítica como Google Analytics, Mixpanel, PostHog y otras para hacer un seguimiento de la interacción de los visitantes."
keywords: ["analítica de terceros", "seguimiento de la interacción", "plataformas de analítica", "seguimiento del uso"]
---

Haz un seguimiento de cómo interactúan los usuarios con tu documentación conectándola a plataformas de analítica de terceros. Mintlify envía eventos de interacción a los proveedores de analítica que hayas configurado.

<div id="how-analytics-integrations-work">
  ## Cómo funcionan las integraciones de analítica
</div>

Cuando agregas integraciones de analítica a tu sitio de documentación, Mintlify registra las interacciones de los usuarios, como vistas de página, búsquedas, solicitudes del entorno de pruebas de API y envíos de comentarios, y las envía a tus proveedores de analítica. Puedes conectar cualquier número de proveedores de analítica compatibles agregando tus claves de API al archivo `docs.json`. Los eventos de analítica se envían a tus proveedores en cuanto los agregas a tu configuración, sin necesidad de realizar ninguna configuración adicional.
...
<image xlinkHref="/docs/images/integrations/clarity.png" width="24" height="24" x="0" y="0" preserveAspectRatio="xMidYMid meet" />
</svg>
}
  />
  ...
  <Card
    ...
    horizontal
    icon={
<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" className="h-6 w-6" viewBox="0 0 40 40">
<defs>
...
<g fill="none">
  ...
  <Card
    ...
    horizontal
    icon={
<svg className="h-6 w-6" width="256" height="256" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
<path
...
<g transform="matrix(.363638 0 0 .363636 -3.272763 -2.909091)">
  ...
  <Card
    ...
    horizontal
    icon={
<svg className="h-6 w-6" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="192px" height="192px" viewBox="0 0 192 192" enableBackground="new 0 0 192 192">
...
c8.59,8.59,22.52,8.59,31.11,0C186.15,102.96,186.15,89.03,177.56,80.44z"
  ...
  <Card
    ...
    horizontal
    icon={
<svg className="h-6 w-6" width="32" height="32" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M78.7 55.2H49V200.2H78.7V55.2ZM142.9 0H113.3V110.5H142.9V0Z" fill="black" />
<path d="M142.9 144.9H113.3V255.4H142.9V144.9ZM207.1 55.2002H177.5V200.2H207.1V55.2002Z" fill="#31D891" />
</svg>
}
  />
  ...
  <Card
    ...
    horizontal
    icon={
<svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" width="97" height="97" viewBox="0 0 97 97" fill="none">
<path d="M33 3.75C33 2.7835 33.7835 2 34.75 2H93.25C94.2165 2 95 2.7835 95 3.75V62.25C95 63.2165 94.2165 64 93.25 64H33V3.75Z" className="fill-black dark:fill-white" />
<path d="M33 93.25C33 94.2165 32.2165 95 31.25 95L3.75 95C2.7835 95 2 94.2165 2 93.25L2 65.75C2 64.7835 2.7835 64 3.75 64L33 64L33 93.25Z" className="fill-black dark:fill-white" />
</svg>
}
  />
  ...
  <Card
    ...
    horizontal
    icon={
<svg className="h-6 w-6" width="51" height="57" viewBox="0 0 51 57" fill="none" xmlns="http://www.w3.org/2000/svg">
<path
...
/>
  ...
  <Card
    ...
    horizontal
    icon={
<svg className="h-7 w-5" width="102" height="159" viewBox="0 0 102 159" fill="none" xmlns="http://www.w3.org/2000/svg">
<path
...
<path d="M78.6018 52.0652C80.547 52.0652 82.1239 50.4883 82.1239 48.5431C82.1239 46.5979 80.547 45.021 78.6018 45.021C76.6566 45.021 75.0798 46.5979 75.0798 48.5431C75.0798 50.4883 76.6566 52.0652 78.6018 52.0652Z"></path>
  ...
  <Card
    ...
    icon={
<>
<svg className="h-6 w-6 dark:hidden" width="1" height="1" viewBox="0 0 1 1" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<svg className="hidden h-6 w-6 dark:block" width="1" height="1" viewBox="0 0 1 1" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g clipPath="url(#clip0_2199_68)">
    <path
      d="M0.184082 0.631579C0.358477 0.631579 0.499871 0.490184 0.499871 0.315789C0.499871 0.141395 0.358477 0 0.184082 0V0.631579ZM0.815661 0.368421C0.641266 0.368421 0.499871 0.509816 0.499871 0.684211C0.499871 0.858605 0.641266 1 0.815661 1V0.368421Z"
      fill="white"
...
<g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
    ...
    <g transform="translate(-19.000000, 0.000000)">
      ...
      <g transform="translate(124.069479, 0.000000)">
        <g transform="translate(376.923077, 500.000000) scale(-1, 1) rotate(-180.000000) translate(-376.923077, -500.000000) translate(2.233251, -0.000000)">
          <circle fill="url(#radialGradient-1)" cx="373.69727" cy="624.069479" r="373.449132" />
          <path
  ...
  <Card
    ...
    horizontal
    icon={
<svg className="h-6 w-6" width="50" height="30" viewBox="0 0 50 30" fill="none" xmlns="http://www.w3.org/2000/svg">
<path
...
Agrega las credenciales de tu proveedor de analítica al objeto `integrations` de `docs.json`. Incluye solo las plataformas que quieras usar.

<Note>
  Las integraciones de analítica solo requieren claves públicas de API, a las que puede acceder cualquier persona que vea tu sitio de documentación. Tus claves privadas de API, que se vinculan con las claves públicas del lado de los proveedores de analítica, deben mantenerse privadas. No incluyas claves privadas de API en tu `docs.json`.
</Note>
...
| :-------------------------------------- | :----------------------------------------------------------------------------------------------------------------------- |
| `docs.content.view`                     | El usuario visita una página. Solo se envía a proveedores que no registran las vistas de página de forma predeterminada. |
| `docs.content.md.view`                  | El usuario visita la versión Markdown de una página.                                                                     |
...
<div id="code-and-api-playground">
  ### Código y entorno de pruebas de API
</div>

| Nombre del evento             | Descripción                                                                |
| :---------------------------- | :------------------------------------------------------------------------- |
| `docs.code_block.copy`        | El usuario copia código de un bloque de código.                            |
| `docs.code_block.ask_ai`      | El usuario pide al asistente que explique un bloque de código.             |
| `docs.api_playground.request` | El usuario realiza una solicitud a la API en el entorno de pruebas de API. |
...
| Nombre del evento       | Descripción                                |
| :---------------------- | :----------------------------------------- |
| `docs.accordion.open`   | El usuario abre un componente Accordion.   |
| `docs.accordion.close`  | El usuario cierra un componente Accordion. |
...
| `docs.assistant.shared`                   | El usuario comparte una conversación del chat.                                            |
| `docs.assistant.thumbs_up`                | El usuario hace clic en el botón de comentarios positivos de una respuesta del asistente. |
| `docs.assistant.thumbs_down`              | El usuario hace clic en el botón de comentarios negativos de una respuesta del asistente. |
...
| `docs.autopilot.suggestion.no_suggestion` | El agente determina que la documentación no necesita actualizarse.                        |
...
| `docs.context_menu.copy_mcp_link`        | El usuario copia el enlace del MCP server alojado.                                                         |
| `docs.context_menu.copy_add_mcp_command` | El usuario copia el comando `npx add-mcp` para instalar el MCP server.                                     |
| `docs.context_menu.ai_provider_click`    | El usuario hace clic en un proveedor de IA para crear una conversación con la página actual como contexto. |
| `docs.context_menu.install_mcp_server`   | El usuario instala el MCP server alojado en editores de código.                                            |