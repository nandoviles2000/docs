---
title: "Thèmes"
description: "Choisissez et configurez un thème pour personnaliser les couleurs de votre site de documentation, le mode sombre, le style de mise en page et l’apparence générale."
mode: "frame"
keywords: ["choix du thème", "Mint", "Maple", "Palm", "Willow", "Linden", "Almond", "Aspen", "Sequoia", "personnalisation de l’apparence"]
---
...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">Personnalisez l’apparence de votre documentation<br /><br />Configurez le [thème](/fr/organize/settings-appearance#theme) dans docs.json en utilisant l’un des thèmes suivants.</label>
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    ...
    <ThemeCard title="Maple" value="maple" description="Esthétique moderne et épurée, idéale pour les produits d’IA et SaaS." href="https://maple.mintlify.app" />
    ...
    <ThemeCard title="Linden" value="linden" description="Une ambiance de terminal rétro avec des polices à chasse fixe pour une esthétique hacker des années 80." href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="Une organisation par cartes associée à un design minimaliste pour une navigation intuitive." href="https://almond.mintlify.app" />
    ...
    <ThemeCard title="Sequoia" value="sequoia" description="Mises en page minimalistes et élégantes conçues pour une documentation riche en contenu à grande échelle." href="https://sequoia.mintlify.app" />
