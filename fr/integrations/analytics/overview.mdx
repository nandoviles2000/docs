...
description: "Connectez votre documentation Mintlify à des plateformes d’analyse comme Google Analytics, Mixpanel, PostHog et bien d’autres pour suivre l’engagement des visiteurs."
keywords: ["analyses tierces", "suivi de l’engagement", "plateformes d’analyse", "suivi de l’utilisation"]
---

Suivez la façon dont les utilisateurs interagissent avec votre documentation en la connectant à des plateformes d’analyse tierces. Mintlify envoie des événements d’engagement aux fournisseurs d’analyse que vous avez configurés.

<div id="how-analytics-integrations-work">
  ## Fonctionnement des intégrations d’analyses
</div>

Lorsque vous ajoutez des intégrations d’analyses à votre site de documentation, Mintlify suit les interactions des utilisateurs, comme les consultations de pages, les requêtes de recherche, les requêtes du bac à sable API et les envois de commentaires, puis les transmet à vos fournisseurs d’analyse. Vous pouvez connecter autant de fournisseurs d’analyse pris en charge que vous le souhaitez en ajoutant vos clés API au fichier `docs.json`. Les événements d’analyse sont envoyés à vos fournisseurs dès que vous les ajoutez à votre configuration, sans aucune configuration supplémentaire.
...
Ajoutez les identifiants de votre fournisseur d’analyses à l’objet `integrations` de `docs.json`. Incluez uniquement les plateformes que vous souhaitez utiliser.

<Note>
  Les intégrations d’analyses ne nécessitent que des clés d’API publiques, accessibles à toute personne qui consulte votre site de documentation. Vos clés d’API privées, associées aux clés publiques chez les fournisseurs d’analyses, doivent rester privées. N’incluez pas de clés d’API privées dans votre `docs.json`.
</Note>
...
<div id="code-and-api-playground">
  ### Blocs de code et bac à sable API
</div>

| Nom de l’événement            | Description                                                      |
| :---------------------------- | :--------------------------------------------------------------- |
| `docs.code_block.copy`        | L’utilisateur copie le code d’un bloc de code.                   |
...
| Nom de l’événement      | Description                                 |
| :---------------------- | :------------------------------------------ |
| `docs.accordion.open`   | L’utilisateur ouvre un Accordion.           |
| `docs.accordion.close`  | L’utilisateur ferme un Accordion.           |
...
| `docs.assistant.source_click`             | L’utilisateur clique sur une citation dans une réponse du chat.                   |
...
| `docs.autopilot.suggestion.created`       | L’agent crée une suggestion pour la documentation.                                |
| `docs.autopilot.suggestion.no_suggestion` | L’agent détermine que la documentation n’a pas besoin d’être mise à jour.         |
...
| `docs.context_menu.copy_add_mcp_command` | L’utilisateur copie la commande `npx add-mcp` pour installer le serveur MCP.                                         |
| `docs.context_menu.ai_provider_click`    | L’utilisateur clique sur un fournisseur d’IA pour créer une conversation en prenant la page actuelle comme contexte. |
