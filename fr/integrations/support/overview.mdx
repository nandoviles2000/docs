...
description: "Connectez votre documentation Mintlify à des plateformes de support comme Intercom et Front pour permettre aux visiteurs d'obtenir de l'aide en direct directement depuis vos pages de documentation."
keywords: ["plateformes de support client", "intégration au centre d'aide", "widgets de support", "assistance client"]
---
...
Intégrez des widgets d’assistance client à votre documentation. Ajoutez le champ `integrations` à votre fichier `docs.json` avec l’ID de votre application ou de votre chat. Consultez la documentation de chaque intégration pour savoir comment trouver votre ID.